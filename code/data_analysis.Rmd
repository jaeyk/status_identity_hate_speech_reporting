...
law_plot <- custom_group_plot(law_summ, "Legislation", rev(c("Gender Discrimination Law", "Hate Speech Law")), 4)
...
ggsave(here("outputs", "comment_reply.png"), height = 7, width = 8)

(platform_plot / law_plot / metoo_plot) + plot_annotation(tag_levels = 'A')
    
ggsave(here("outputs", "else_summ.png"), height = 10, width = 12)
```
